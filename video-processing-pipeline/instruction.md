- You will work only in the directory `video-processing-pipeline`
- Build with python 3.12
- Ignore the previous implementation that can be found in git files
- Take the `video-processing-pipeline/docker-compose.yaml` as a base
...
- test video file is the following: `video-processing-pipeline/input.mp4`
